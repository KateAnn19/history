...
<body class="fixed-header pattern-bg">
    ...
    <div id="header-container">
      <header>
        ...
        <div class="container">
          <div class="row">
            <h1 class="title"><a href="index.html">Sample Site Page 2</a></h1>
    ...
    <section id="search-results">
        ...
        <?php echo '<div class="results-count">' . '<h5>' . count($result-> results) . " " . "results" . '</h5>'; '</div>'; ?>
        </div>
    <div class="container">
        <!-- Title -->
        ...
        if(!empty($result->results)){
            for ($x = 0; $x < count($result->results); $x+=1) {
                $first_item = $result->results[$x];
                $description = '';
                $date = '';
                $image = '';
            ...
            print "<div class='row project-item'>
            <a href=articleview.html>
              <div class=col-sm-3><img src={$image}/></div>
                <div class=col-sm-3 col> <span> Title </span> {$first_item->name} </div>
                <div class=col-sm-3 col> <span> Year </span> {$date} </div>
                <div class=col-sm-3> {$description} </div>
            </a>
            </div>";
            // echo '<div class="row project-item">';
            //     echo '<a href="articleview.html">';
            //         echo '<div class="col-sm-3">' . "<img src=\"" . $image . "\" />";'</div>';
            //         echo '<div class="col-sm-3 col">' . '<span>'. "Title" . '</span>' . $first_item->name . '</div>';
            //         echo '<div class="col-sm-3 col">' . '<span>' . "Year" . '</span>' . $date . '</div>';
            //         echo '<div class="col-sm-3">' . $description . '</div>';'</a>';
            // echo '</div>';
            }
        }?>
        </div>
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="pagination">
              ...
              <a href="results.php" class="selected">1</a>
              <a href="#">2</a>
              <a href="#">3</a>
              <!-- <a href="#">4</a>
              <a href="#">5</a> -->
...
<!-- 
echo "<h1>""ID: " . $first_item->id . "</h1>";
            echo '<div class="cont">';
            echo '<h1 class="title">' . "Title: " . $first_item->name . '<br/>';'</h1>';
        echo '<h1>' . '<p>' . $description . '<br />';'</p>';'</h1>';
            echo '<h1>' . $description . '<br/>';'</h1>';
