...
<body class="fixed-header pattern-bg">
    ...
    <div id="header-container">
      <header>
        ...
        <div class="container">
          <div class="row">
            <h1 class="title"><a href="index.html">Sample Site Page 3</a></h1>
    ...
    <div class="container">
        ...
        if(!empty($result->results)){
            ...
            if($image == ''){
                $image = "https://images.unsplash.com/photo-1600248341994-d6039881e693?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=658&q=80";
            }
